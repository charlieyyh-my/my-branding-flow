...
BrandOS for Century Mark Pacific Marketing — a multi-user internal tool for planning, creating, approving, publishing, and tracking one week of branded content across all platforms.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "241322238+charlieyyh-my@users.noreply.github.com"
  git config user.name "charlieyyh-my"
  ```
