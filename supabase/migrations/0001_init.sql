...
insert into content_items (id, title, platform, copy_body, scheduled_date, status, campaign_id, weekly_theme_id, assigned_to) values
  ...
  ('c1000000-0000-0000-0000-000000000002', 'CNY Corporate Gift Guide — Rednote Post', 'Rednote', 'Planning your CNY corporate gifts? Moutai Feitian sets a new standard for business relationships. Enquire now.', '2025-01-15', 'in_review', 'a1000000-0000-0000-0000-000000000002', 'b1000000-0000-0000-0000-000000000001', 'Jason Tan'),
  ...
  ('c1000000-0000-0000-0000-000000000005', 'Authorised Importer Badge — Facebook Post', 'Facebook', 'Only Century Mark Pacific holds the official Moutai import licence in Malaysia. Share this with confidence.', '2025-01-18', 'published', 'a1000000-0000-0000-0000-000000000001', 'b1000000-0000-0000-0000-000000000001', 'Jason Tan');
